...
## Done when
- [x] conda env `dronegym` (py3.12) created, with what you need installed (pip install mujoco cflib cfclient)
- [x] MuJoCo hello-world runs and renders
- [x] `.gitignore` covers logs, recordings, `__pycache__`, MuJoCo caches
- [x] `docs/setup.md` written or updated — what it does, how to run it
- [x] `DECISIONS.md` entry if a choice was made — what we picked, what we rejected, why
